                ...
                transformerlayers=dict(
                    ...
                    attn_cfgs=[
                        ...
                        dict(
                            ...
                            type='PETRMultiheadAttention',  # no flash attention support
                            embed_dims=256,
                            num_heads=8,
                            dropout=0.1),
                    ],
...
data = dict(
    ...
    train=dict(
        ...
        box_type_3d='LiDAR'),
    val=dict(type=dataset_type, pipeline=test_pipeline, collect_keys=collect_keys + ['img', 'img_metas'],
             queue_length=queue_length, ann_file=data_root + 'nuscenes2d_temporal_infos_val.pkl', classes=class_names,
             modality=input_modality),
    test=dict(type=dataset_type, pipeline=test_pipeline, collect_keys=collect_keys + ['img', 'img_metas'],
              queue_length=queue_length, ann_file=data_root + 'nuscenes2d_temporal_infos_val.pkl', classes=class_names,
              modality=input_modality),
...
load_from = None
resume_from = None
work_dir = "./Checkpoints/stream_petr_r50_704_bs2_24e"
